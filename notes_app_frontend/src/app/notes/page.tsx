    ...
    return (
        <div className="p-8">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={handleLogout} className="px-4 py-2  border rounded-lg cursor-pointer hover:bg-red-500/25 hover:border-red-500 transition duration-300 focus:outline-0 focus:border-red-500 focus:bg-red-500/25">Logout</button>
            </div>
            ...
            <form onSubmit={handleCreateNote} className="mb-6 space-y-4">
                ...
                <textarea 
                    ...
                    required
                />
                <button type="submit" className="px-4 py-2 border rounded-lg cursor-pointer hover:bg-green-500/25 hover:border-green-500 transition duration-300 focus:outline-0 focus:border-green-500 focus:bg-green-500/25">
                    Add note
                </button>
            </form>
